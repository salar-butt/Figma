    ...
    <div className="basicform wadeform form3">
      ...
      <div className="alreadyhave">
          ...
          <div className="wadewarren">
              ...
              <h4 value="basicinfo" className="bluee">Edit</h4></div>
              <div className=" infodiv1 infodiv2"><i class="fa-solid fa-envelope"></i><p>Credentials</p>
              <button className="bluee" >Edit</button></div>
              ...
              <button  className="bluee">Add</button></div>
          ...
          <div className="resume">
              ...
              <div className="summary">
                ...
                <button  style={{color:"blue"}} >Edit</button></div>
                <div className="editt">
